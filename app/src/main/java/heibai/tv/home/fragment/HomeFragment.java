...
import heibai.tv.home.activity.ListActivity;
import heibai.tv.home.adapter.RecyclerViewAdapter;

/**
 * Created by Ozawa on 2017/3/3.
 */
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View parentView = inflater.inflate(R.layout.home_fragment, container,
                false);
...
//        });
        ...
        adapter.setOnItemClickListener(new RecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.setClass(getMyActivity(),ListActivity.class);
